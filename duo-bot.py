...
def load_or_init_config():
    try:
        ...
        encrypted_otpauth = base64.b64encode(args.otpauth.encode('utf-8')).decode('utf-8')
        return {'otpauth': encrypted_otpauth, 'counter': 0, 'logs': []}
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if 'duo' in text.lower() and args.password in text:
